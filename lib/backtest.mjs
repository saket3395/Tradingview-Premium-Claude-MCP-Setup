...
export async function runBacktest(gateCfg, limit = 100) {
  ...
  if (!token) return { ok: false, error: 'No NSE data token — point NSE_DATA_TOKEN_FILE at a long-lived analytics token (read-only, ~1yr validity, no daily refresh); backtest needs historical candles.' };
